window.onload = function () {
    ...
    var selectd=document.getElementById("selected");
    var foot=document.getElementsById("foot");
    var selectdViewList=document.getElementsById("selectdViewList");
    var deleteAll=document.getElementsById("deleteAll");
    function getTotal() {
        var seleted = 0;
        var price = 0;
        ...
        selectdViewList.innerHTML=HTMLstr
        if(selectd==0){
            foot.className="foot";
        }
...
selectdViewList.onclick=function(e){
    e=e||window.event;
   var el=e.srcElement;
   if(el.className=="del"){
...
for(var i=0;i<tr.length;i++){
    tr[i].onclick=function(e){
        ...
        var reduce=this.getElementsById("span")[1];
        switch(cls){
            case "add":
                input.value=val+1;
                reduce.innerHTML="-";
    ...
    tr[i].getElementsByTagName("input")[1].onkeyup=function(){
        ...
        var tr =   getSubTotal(this.parentNode.parentNode);
